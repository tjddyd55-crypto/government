...
export default function GovernmentProfileWorkspaceTabsPCView(props: GovernmentProfileWorkspaceTabsProps) {
  const { activeTab, selectedProfileId } = props
  const disabled = !selectedProfileId

  return (
    <nav
      className="government-profile-workspace-tabs government-profile-workspace-tabs--pc"
      aria-label="사업장 작업 탭"
    >
